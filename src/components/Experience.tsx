...
const Experience = () => {
  return (
    ...
    >
      <h3 className="text-3xl font-semibold mb-4 text-white">Experience</h3>
      <div className="bg-gray-800 p-6 rounded-lg shadow-lg max-w-3xl mx-auto space-y-6">
        <div>
          <h4 className="text-2xl font-bold text-white">Flutter Developer</h4>
          <p className="text-blue-400">Levelx</p>
          <p>06/2023 to 23/2024, Calicut</p>
        ...
        <div>
          <h4 className="text-2xl font-bold text-white">Flutter Developer</h4>
          <p className="text-blue-400">Akira Software Solution</p>
          <p>26/08/2024 - Present, Thiruvananthapuram</p>
          <ul className="list-disc list-inside text-left text-gray-300">

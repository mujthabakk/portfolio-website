    ...
    <div className="relative min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white flex items-center">
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold">Muhammed Mujthaba</h1>
            <h2 className="text-2xl md:text-3xl text-blue-400">Flutter Developer | Mobile App Specialist</h2>
            <p className="text-gray-300 text-lg leading-relaxed">
              A highly skilled Flutter Developer specializing in cross-platform mobile app development for Android, iOS, and Web. Experienced in Flutter, Firebase, GetX, Riverpod, Bloc, Provider, REST APIs, and UI/UX design.
            </p>
            <div className="flex flex-wrap gap-4">
              <button 
                onClick={() => document.getElementById('projects')?.scrollIntoView({ behavior: 'smooth' })} 
                className="px-8 py-3 bg-blue-500 hover:bg-blue-600 rounded-full font-semibold transition-colors"
              >
                View Projects
              </button>
              <a 
